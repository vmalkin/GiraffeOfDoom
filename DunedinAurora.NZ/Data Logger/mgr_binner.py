...
# #################################################################################
# Rawdata is in the format (UnixDatetime, data)
# bin_interval is the number of items that will be binned at a time, independent of a time value
# the time value for the bin will be the LAST (most recent) value in the bin range
# the function will return an array of (UnixDatetime, binned_value))
# #################################################################################
def bin_complex(rawdata_array, bin_interval):
    pass
