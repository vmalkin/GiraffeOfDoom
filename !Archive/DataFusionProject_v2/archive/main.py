...
while True:
    ...
    date_data = []
    # Go thru the temp datadata and write out unique datetimes only, to the final merged list.
    ...
    for dateitem in date_data:
        ...
        for magstation in stationlist:
            ...
            # we went thru the list of stations and there was no entry for this date/datatime
    ...
    # One final task - re-write the final merged datadata for values that do NOT have a zero in them.
    # temp_data = []
