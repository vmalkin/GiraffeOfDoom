...
_oiqq.push(['oiq_addPageBrand', 'Microsoft Windows']);
...
(function() {
  var shrLoccLoader = setInterval(function() {
    if (document.body) {
      ...
      locc_pixel.src = document.location.protocol + "//bcp.crwdcntrl.net/map/c=9193/tp=SHLC/tpid=4a0a04f7-22ac-4364-85ca-8251c41b970a";
...
(function() {
    ...
    locc_human.src = document.location.protocol + '//n-cdn.areyouahuman.com/play/YNMJrK4lsMAJlxSsJDb17LW8YmmHRLakZxkWagp6?AYAH_F2=www.meccanismocomplesso.org&AYAH_P2=4a0a04f7-22ac-4364-85ca-8251c41b970a&AYAH_F1=Lotame';
  ...
  var bkInt = setInterval(function(){
    if(document.body){
      ...
      bksrc.onload = function() {
                ...
                bk_addPageCtx("sh005", "1112487");
                bk_addPageCtx("sh001", "10930639");
...
(function(){try{var p,s,w=window.top;w.Tynt=w.Tynt||[];
w.Tynt.push('sh!sh');s=w.document.createElement('script');
p=w.location.protocol;s.src=(p==='https:'?p:'http:')+'//cdn.tynt.com/afsh.js';
