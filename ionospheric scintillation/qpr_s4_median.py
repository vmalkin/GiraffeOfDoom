...
def plot_lineplot(xval, yval):
    ...
    fig.update_layout(width=1700, height=900, title="S4 Avg Index, GPS & Glonass Constellations. http://DunedinAurora.NZ", xaxis_title="Date/time UTC", yaxis_title="S4 Index", plot_bgcolor="#101010")
