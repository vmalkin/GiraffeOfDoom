...
namespace SerialDataExample
{
    public partial class Form1 : Form
    {
        ...
        {
            // Using the currentUTC file...
            string logFile = "CurrentUTC.csv";
            ...
            if(File.Exists(logFile))
            {
                ...
                {                  
                    ...
                    // The first line of the file contains headers; ignore.
                    if (values[0] != "Date UTC")
                    {
                        // create a new datapoint and add to the datapoint array
