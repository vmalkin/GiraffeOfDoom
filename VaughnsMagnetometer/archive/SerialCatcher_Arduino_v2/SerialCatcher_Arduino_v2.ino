...
int waitCounter = 0;
const int waitTimer = 4000; // wait timer for printing results to serial. 8000 = 25sec. 
...
void print_values(void)
{
  ...
  {
    // The hash-coding is to allow GoBetwuino to log the data correctly
    // This can be removed if we're using some other method to record the
    // Uno's serial output.
    ...
    waitCounter = 0; // reset the wait counter
  }
}
