...
def plot(dates, data):
    ...
    fig.add_hrect(y0=sig_2, y1=sig_3, line_width=0, fillcolor="green", opacity=0.4, layer="below",
                  annotation_text="± 1 StdDev", annotation_position="top right")
    fig.add_hrect(y0=sig_1, y1=sig_4, line_width=0, fillcolor="green", opacity=0.4, layer="below",
                  annotation_text="± 2 StdDev", annotation_position="top right")
